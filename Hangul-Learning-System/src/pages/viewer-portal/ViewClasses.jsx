      ...
      <div style={{
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{
            ...
            <BookOutlined style={{ fontSize: 24, color: '#fff', marginRight: 8 }} />
          ...
          <Text style={{ 
            ...
            Tham gia ngay các lớp học tiếng Hàn chất lượng cao với giảng viên giàu kinh nghiệm
          </Text>
        </div>
      </div>
          ...
          <Row gutter={[16, 16]} align="middle">
            <Col xs={24} sm={24} md={8} lg={8}>
              <Search
                ...
                allowClear
                enterButton={<SearchOutlined style={{ color: '#d4af37' }} />}
                size="large"
                value={searchTerm}
            ...
            <Col xs={24} sm={12} md={5} lg={5}>
              <Select
                ...
                style={{ width: '100%' }}
                suffixIcon={<DollarOutlined style={{ color: '#d4af37' }} />}
              >
            ...
            <Col xs={24} sm={12} md={5} lg={5}>
              <Select
                ...
                onChange={setSortBy}
                style={{ width: '100%' }}
                suffixIcon={<FilterOutlined style={{ color: '#d4af37' }} />}
              >
